...
Energy use ***E*** in kWh is calculated for sets of devices with `_i_ = 1,2 ...
_n_` as an index for the category of device, including cooking, lamps,
streetlights, electric appliances, and electricity generation devices. The index
`_j_ = 1,2 ... _n_` denotes the sub-type within a category, such as the type of
